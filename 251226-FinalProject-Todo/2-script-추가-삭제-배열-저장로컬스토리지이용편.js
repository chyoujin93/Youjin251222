...
// 추가팁
// JSON.stringify와 JSON.parse는 개념 예시 
// JSON이란? (개발자라면 꼭 알아야하는 개념)
// : JavaScript Of Notation의 약자. (자바스크립트 객체 표기법)
// : 데이터 저장 또는 전송할 때 많이 쓰이는 경량의 텍스트 데이터 형식.
// : 비유하면 택배상자. (뭔가를 담아서 보낸다.)
